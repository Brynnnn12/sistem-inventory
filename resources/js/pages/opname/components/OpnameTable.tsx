                ...
                <TableBody>
                    {opnames.map((opname) => (
                        <TableRow key={opname.id} className="group">
                            ...
                            <TableCell>
                                <div
                                    className={`font-medium ${opname.difference_type === 'lebih' ? 'text-green-600' : opname.difference_type === 'kurang' ? 'text-red-600' : 'text-gray-600'}`}
                                >
                                    {opname.difference_type === 'lebih'
                                        ? '+'
                                        : opname.difference_type === 'kurang'
                                          ? '-'
                                          : ''}

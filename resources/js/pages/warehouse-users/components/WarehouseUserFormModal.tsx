            ...
            <DialogContent className="sm:max-w-125">
                <form onSubmit={handleSubmit}>
                    <ModalHeader
                        ...
                        title={
                            isEditing
                                ? 'Pindah Gudang Pengguna'
                                : 'Tetapkan Pengguna ke Gudang'
                        }
                        description={
                            isEditing
                                ? 'Pindahkan penugasan pengguna ke gudang lain'
                                : 'Hubungkan pengguna dengan lokasi gudang'
                        }
                    />
                    <div className="space-y-4 py-4">
                        <div className="space-y-2">
                            <Label
                                htmlFor={`${isEditing ? 'edit' : 'create'}-warehouse`}
                            >
                                Gudang{' '}
                        ...
                        <div className="space-y-2">
                            <Label
                                htmlFor={`${isEditing ? 'edit' : 'create'}-user`}
                            >
                                Pengguna{' '}
                                <span className="text-destructive">*</span>
                            </Label>
                        ...
                        <div className="space-y-2">
                            <Label
                                htmlFor={`${isEditing ? 'edit' : 'create'}-assigned-at`}
                            >
                                Tanggal Penugasan{' '}
                                <span className="text-destructive">*</span>
                            </Label>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            />
                            <Label
                                htmlFor={`${isEditing ? 'edit' : 'create'}-is-primary`}
